...
const CustomerPage = () => {
    ...
    useEffect(() => {
        ...
        // Update other state variables for other fields if needed
    }, [user]);
        ...
        <div>
            ...
            <div className='maindiv'>
                    ...
                    <div className="navbar-menu">
                        ...
                        <div className="shopping-cart" style={{ display: "flex", gap: "10px" }}>
                            ...
                            <div className="avatar">
                                {/* Avatar picture */}
                                <img onClick={() => { navigate("/profile") }} style={{ marginTop: "-2%" }} src={pic} alt="Avatar" />
                                        ...
                                        {cart.map((product) => (
                                            <li key={product._id}>
                                                <div style={{ display: "flex", gap: "20px" }}>
                                                    <p>{product.title}</p>
                                                    <p> ${product.price}</p>
                                                    <img style={{ backgroundColor: "#fff", marginBottom: "10px", right: "60px", height: "30px", width: "30px" }} className='addtocart' src="https://th.bing.com/th/id/OIP.Q9t4awyuirh3UwXfTFzGSgHaHa?pid=ImgDet&rs=1"/>
                ...
                <div className="displayimage" style={{ display: "flex", gap: "60px", textAlign: "center" }}>
                    <img style={{ width: "100vw" }} src="https://i.pinimg.com/originals/6f/39/35/6f393516f4f2876c5ff1b8ddcf57c638.jpg"/>
