...
import { setUser, setIsLoggedIn, setLoading, setError, selectUser, updateAddress, updateNumber, updateDisplayName } from '../../features/userSlice';
...
const Profile = () => {
  ...
  //       setEmail(userfromredux.user.email)

  //       setPhone(userfromredux.user.number)


  //       setPhone(userfromredux.user.number)
  //       setName(userfromredux.user.displayName)
  //       setTotalOrders(userfromredux.user.address)
  //       if (userfromredux.user.password !== undefined)
  //         setPassword(userfromredux.user.password)
  //       else
  //         setPassword("")
  //       if (userfromredux.user.profile !== undefined) setPic(userfromredux.user.profile)

  //       userfromredux.user.profile == undefined && setPic("https://img.freepik.com/free-vector/cheerful-cute-girl-character-hand-drawn-cartoon-art-illustration_56104-968.jpg?w=2000")
  // },[])
  useEffect(() => {
